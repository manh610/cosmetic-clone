...
public class FavoriteController {
	...
	public ResponseEntity<Response<?>> search(
		...
		try {
			List<ProductResponse> products = favoriteService.search(id);
			return new ResponseEntity<>(
		        new Response<List<ProductResponse>>().success(
		          transId,
		          products.size(),
		          products
		        ),
	...
	public ResponseEntity<Response<?>> addProduct(
		...
		try {
			...
			List<Error> errors = favoriteService.validator(favorite);
			if(!errors.isEmpty())
				return new ResponseEntity<>(
			...
			Favorite favoriteEntity = favoriteService.addProduct(favorite);
	...
	public ResponseEntity<Response<?>> removeProduct(
		...
		String transId = UUID.randomUUID().toString();
		try {
			Error error = favoriteService.removeProduct(userId, productId);
